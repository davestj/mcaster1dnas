...
<head>
    ...
    <title>Mount Points - Mcaster1DNAS</title>
...
<body>
    <xsl:call-template name="admin-header">
        <xsl:with-param name="active-page" select="'mounts'"/>
        <xsl:with-param name="title" select="'Mount Points - Mcaster1DNAS'"/>
    </xsl:call-template>
    ...
    <div class="mcaster-main">
        <div class="mcaster-container">
            ...
            <div class="mcaster-card">
                <h2>
                    <i class="fas fa-server"></i> Global Server Mounts
                    <span class="tooltip">
