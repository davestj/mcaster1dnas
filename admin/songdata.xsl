...
<head>
    ...
    <title>Track History - Mcaster1DNAS Admin</title>
        ...
        <div class="mcaster-container">
            ...
            <div class="mcaster-card">
                ...
                <div style="margin-bottom:1rem;">
                    <a href="songdata.xsl" class="admin-action-btn">
                        <i class="fas fa-sync-alt"></i> Refresh
                    </a>
                    <a href="stats.xsl" class="admin-action-btn">
                        <i class="fas fa-chart-line"></i> Server Stats
                    </a>
                    <a href="listmounts.xsl" class="admin-action-btn">
                        <i class="fas fa-stream"></i> Mount List
                    </a>
                </div>
