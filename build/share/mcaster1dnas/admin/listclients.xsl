...
<head>
    ...
    <title>Client List - Mcaster1DNAS Admin</title>
        ...
        <div class="mcaster-container">
            ...
            <xsl:for-each select="source">
                <div class="mcaster-card">
                    <h2>
                        <i class="fas fa-users"></i> Clients on Mount: <xsl:value-of select="@mount"/>
                    ...
                    <xsl:if test="not(listener)">
                        <p style="text-align: center; padding: 2rem; color: var(--text-secondary);">
                            <i class="fas fa-info-circle"></i> No clients currently connected to this mount.
                        </p>
                    </xsl:if>
                </div>
            </xsl:for-each>
