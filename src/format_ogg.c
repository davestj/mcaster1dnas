...
static int  create_ogg_client_data(format_plugin_t *plugin, mc_http_t*,client_t *client);
...
static int create_ogg_client_data (format_plugin_t *plugin, mc_http_t *http, client_t *client)
{
