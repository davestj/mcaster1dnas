...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ── LED Ticker Display (amber — public player) ── */
        .media-display {
            position: relative;
            background: #010b0f;
...
<body>
    ...
    //<![CDATA[
        ...
        window.addEventListener('load', function() {
            ...
            const savedVol = localStorage.getItem('mcaster1_volume');
            if (savedVol) {
            ...
            // Preload history in background so it's ready when tab is clicked
        ...
        function switchTab(name) {
            ...
            if (name === 'history') {
                // Reload history whenever the tab is opened
                loadSongHistory();
            }
        }
            ...
            fetch('/songdata.xsl')
                ...
                .then(function(html) {
                    ...
                    rows.forEach(function(row) {
                        ...
                        // Get title text (strip out the now-playing-dot text if any)
            ...
            fetch('/status-json.xsl')
                ...
                .then(function(data) {
                    ...
                    if (titleEl && newTitle && titleEl.textContent !== newTitle) {
                        ...
                        // Refresh history silently when song changes
                        loadSongHistory();
                    }
