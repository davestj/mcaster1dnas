// Mcaster1WinDlg.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CMcaster1WinDlg message handlers
...
void CMcaster1WinDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CMcaster1WinDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CMcaster1WinDlg::OnSelchangeMaintab(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CMcaster1WinDlg::LoadConfig()
{
	FILE	*filep;
	char	buffer[2046] = "";
...
void CMcaster1WinDlg::OnFileExit() 
{
...
void CMcaster1WinDlg::getTag(char *pbuf, char *ptag, char *dest)
{
	char	openTag[256] = "";
	char	closeTag[256] = "";
...
void CMcaster1WinDlg::EnableControl(UINT control)
{
	CWnd	*pWnd;
...
void CMcaster1WinDlg::DisableControl(UINT control)
{
	CWnd	*pWnd;
	pWnd = GetDlgItem(control);
...
{
	while (global.running != MC_RUNNING) {
		Sleep(500);
	}
	while (global.running == MC_RUNNING) {
...
char	g_progName[255] = "mcaster1dnas";
...
void CMcaster1WinDlg::OnFileStopserver() 
{
	// TODO: Add your command handler code here
	;
}
...
void CMcaster1WinDlg::UpdateStatsLists()
{
	char	item[1024] = "";
	int l = 0;
...
char	gAppName[255] = "mcaster1dnas";
char	gConfigFile[255] = "mcaster1dnas.ini";

void CMcaster1WinDlg::config_write()
{
	char	buf[255] = "";
	char	buf2[1024] = "";
...
void CMcaster1WinDlg::config_read()
{
	char	buf2[1024] = "";
	char	buf[1024] = "";
	CString	tempString;
...
void CMcaster1WinDlg::OnHidesystray() 
{
	// TODO: Add your control notification handler code here
	OnHide();
	theApp.HideApplication();	
}
void CMcaster1WinDlg::OnHide() 
{
	// TODO: Add your control notification handler code here
	if (m_pTray == NULL) {
...
void CMcaster1WinDlg::OnFileEditconfiguration() 
{
	// TODO: Add your command handler code here
