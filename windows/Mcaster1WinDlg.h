...
public:
	...
	void ParseConfig();
	void LoadConfig();
	CMcaster1WinDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	//{{AFX_DATA(CMcaster1WinDlg)
	enum { IDD = IDD_MCASTER1WIN_DIALOG };
	CStatic	m_SS;
...
#endif // !defined(AFX_MCASTER1WINDLG_H__23B4DA8B_C9BC_49C8_A62C_37FC6BC5E54A__INCLUDED_)
